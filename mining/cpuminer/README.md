...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/BcdPlus/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/BcdPlus/mining/cpuminer
```
