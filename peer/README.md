...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/BcdPlus/peer)
...
```bash
$ go get -u github.com/BcdPlus/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/BcdPlus/peer#example-package--NewOutboundPeer)  
